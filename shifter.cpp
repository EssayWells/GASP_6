...
int main(int argc, char *argv[]){
  ...
  cout << endl << endl; 
  cout << "Welcome to shifter, which shifts all the fractional coordinates in an cif file." << endl;
  ...
  if ( argc < 6  ){
    ...
    cout << "Reads structure from CIF file NameIn and outputs to NameOut" << endl;
