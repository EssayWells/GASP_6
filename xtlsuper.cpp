...
int main(int argc, char *argv[]){
  ...
  cout << endl << endl; 
  cout << "Welcome to Super, which makes a supercell from an xtl file." << endl;
  ...
  if ( argc < 6  ){
    ...
    cout << "Reads structure from XTL file NameIn and output to NameOut" << endl;
  ...
  structure.writextl( outfilename, otitle.str(), false );
